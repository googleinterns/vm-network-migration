...
class GlobalForwardingRule(ForwardingRule):
    ...
    def get_target_proxy_configs(self, target_proxy_type, target_proxy_name):
        if target_proxy_type == 'targetHttpProxies':
            compute_engine_api = self.compute.targetHttpProxies()
        elif target_proxy_type == 'targetHttpsProxies':
    ...
    def get_backend_service_selfLinks_from_target_proxy_configs(self, target_proxy_configs) -> list:
        ...
        return []
    def get_backend_service_selfLinks(self):
        if self.forwarding_rule_configs != None:
            ...
            target_proxy_configs = self.get_target_proxy_configs(target_proxy_type, target_proxy_name)
            return self.get_backend_service_selfLinks_from_target_proxy_configs(target_proxy_configs)
        return []