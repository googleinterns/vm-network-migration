...
class InstanceTemplate:
    ...
    def get_instance_template_body(self):
        ...
        return self.compute.instanceTemplates().get(project=self.project, instanceTemplate=self.instance_template_name).execute()

    def insert(self):


        insert_operation = self.compute.instanceTemplates().insert(project=self.project,
    ...
    def delete(self):
        delete_operation = self.compute.instanceTemplates().delete(project=self.project, instanceTemplate=self.instance_template_name)
    ...
    def modify_instance_template_with_new_network(self, new_network_link,
        ...
        """
        self.instance_template_body['networkInterfaces'][0][
