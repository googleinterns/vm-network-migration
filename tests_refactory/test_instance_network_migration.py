...
class TestRollbackOriginalInstance(unittest.TestCase):
    ...
    def test_rollback_without_original_instance_template(self):
        ...
        InstanceNetworkMigration.rollback_original_instance(instance_network_migration)
...
class TestRollbackFailureProtection(unittest.TestCase):
    def test_rollback_success(self):
        ...
        rollback_result = InstanceNetworkMigration.rollback_failure_protection(instance_network_migration)
...
class TestGenerateAddress(unittest.TestCase):
    ...
    def test_generate_address(self):
        ...
        address = InstanceNetworkMigration.generate_address(instance_network_migration, instance_template)
...
class TestGenerateNetwork(unittest.TestCase):
    ...
    def test_generate_network(self):
        ...
        network = InstanceNetworkMigration.generate_network(instance_network_migration, "mock-network", "mock-subnetwork")
...
class TestNetworkMigration(unittest.TestCase):
    ...
    def test_unchanged_new_instance_name(self, *mocks):
        ...
        "status": 200,
        "reason":  "H"})
        request_builder.responses["compute.networks.get"] = (successResponse, b'')
        compute = build("compute", "v1", self.http,
                        requestBuilder=request_builder)
        mocks[0].return_value = compute
